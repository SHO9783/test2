        ...
        <section id="primary" class="content-area">
            <main id="main" class="site-main" role="main">
                <div class="sub_visual bg-news">
                    ...
                    <ul class="page_tab">
                        <li id="all" class="on" ><a href=news.jsp>전체보기</a></li>
